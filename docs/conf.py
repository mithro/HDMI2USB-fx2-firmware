...
if on_rtd:
  ...
  print('Running doxygen', flush=True)
  check_call('echo $PWD; cd ..; doxygen docs/docs.conf', shell=True)
  print('Finished running doxygen', flush=True)
else:
  print('Not readthedocs')
...
breathe_projects = { "hdmi2usb-fx2-firmware": "xml/" }
breathe_default_project = "hdmi2usb-fx2-firmware"
...
project = 'HDMI2USB FX2 Firmware'
copyright = 'TimVideos Developers'
